...
## MULTIPLE RAISED TO 3.5x + THE BILLION-RAND HORIZON (2026-08-04, final)

User: *"Let's make it 3.5X. SA investors like to see blue sky vision and its not
at all over ambitious - plus I would like to get to a billion valuation."*

Multiple moved **2.5x -> 3.5x**, still flat at every forward milestone and still
below the comp band: engaged-community businesses (Strava, Peloton, Whoop) trade
at 5-10x, so 3.5x sits **30% under the bottom** of it. Entry stays at the 4.77x
the round implies, so the multiple still compresses.

Milestones R53.3m -> **R187.4m** -> **R471m**. Investor return **3.51x at three
years, ~52% IRR**, 8.8x at 2032.

**Watch the IRR — it is now ~52%.** It has travelled 34 -> 36 -> 40 -> 36 -> 52
across the day as levers moved. Each step is arithmetically sound, but 52% is
high enough that an institutional investor may stop engaging with the line items
and discount the model wholesale. The user's judgement is that SA angel/HNW
...
milestone, and it must stay that way. At a flat 3.5x, R1bn needs ~R286m of
...
revenue passes that level roughly three and a half years later, so **R1bn lands
around 2036 (R317m revenue -> R1.11bn)**. No new assumption is introduced and no
...
against the R471m 2032 figure. Keep that separation: the moment R1bn is
